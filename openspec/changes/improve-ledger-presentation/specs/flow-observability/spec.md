...
**Reason**: Renamed to The Ledger, and its prohibition on presenting a figure keyed to an operator
identifier is retired. That prohibition is already contradicted by the accepted requirement "The operator
dimension covers agents and humans alike" and by the code merged for it; leaving it would keep the spec
self-contradictory.
**Migration**: "The Ledger" carries every other property of this requirement, renames the surface, adds
tabbed navigation, and drops the retired scenario "The Board shows no per-operator figure". Pseudonymity is
carried by the operator dimension requirement and by the unchanged guards in the record schema.
